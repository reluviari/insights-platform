...
export default function Upload(props: JSX.IntrinsicAttributes & SVGProps<SVGSVGElement>) {
  ...
  return (
    ...
    >
      <rect x="3" y="3" width="40" height="40" rx="20" fill="#E8E8E8" />
      <g clipPath="url(#clip0_2296_4409)">
        <path
      ...
      <rect x="3" y="3" width="40" height="40" rx="20" stroke="#EFF2F5" strokeWidth="6" />
      <defs>
        <clipPath id="clip0_2296_4409">

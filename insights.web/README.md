...
Na pasta **pai** (`insights-platform`), siga o tutorial com `docker compose`; o front já recebe `NEXT_PUBLIC_*` via `.env` na raiz — veja [.env.docker.example](../.env.docker.example).
